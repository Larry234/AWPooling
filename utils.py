...
def get_network(net, num_class=100, device=None):
    ...
    if net == 'vgg16':
        ...
        from models.vggaw import VGG11AWT
        model = VGG11AWT(num_class=num_class)
    elif net == 'vgg13awt':
        from models.vggaw import VGG13AWT
        model = VGG13AWT(num_class=num_class)
    elif net == 'vgg16awt':
        from models.vggaw import VGG16AWT
        model = VGG16AWT(num_class=num_class)
    elif net == 'vgg19awt':
        from models.vggaw import VGG19AWT
        model = VGG19AWT(num_class=num_class)
...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    cifar100_training = torchvision.datasets.CIFAR100(root='/home/larry/Datasets', train=True, download=True, transform=transform_train)
...
def get_test_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    cifar100_test = torchvision.datasets.CIFAR100(root='/home/larry/Datasets', train=False, download=True, transform=transform_test)
